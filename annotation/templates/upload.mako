...
<link rel="stylesheet" href="${appbase}resources/libs/Cesium-1.1/Build/Cesium/Widgets/widgets.css">
<!--
...
<script type="text/javascript" src="${appbase}resources/libs/popcorn/popcorn-complete.min.js"></script>
<script type="text/javascript"  src="${appbase}resources/libs/Cesium-1.1/Build/Cesium/Cesium.js"></script>
